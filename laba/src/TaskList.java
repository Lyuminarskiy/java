...
public class TaskList  {
    ...
    public void Update(Population population) throws IOException {
        for (var i : table) {
    ...
    public void Delete(String data) throws IOException {
        List<Integer> list = ParseInt(data);
        if(list.size() > 0)
            Delete(list);
    }

    public void Delete(List<Integer> years) throws IOException {
        for (var i : years) {
    ...
    public void Show(List<Integer> years) {
